...
function createDeleteButton(val) {
  var btnDelete = document.createElement("INPUT");
  btnDelete.type = "button";
  btnDelete.id="delete";
  btnDelete.value = val;
  btnDelete.setAttribute("onclick", "formModule.deletecnfr(this);");
  return btnDelete;
}

function createEditButton(val) {
  var btnEdit = document.createElement("INPUT");
  btnEdit.type = "button";
  btnEdit.id= "edit";
  btnEdit.value = val;
  btnEdit.setAttribute("onclick", "formModule.editRow(this);");
  return btnEdit;
}

/*function for delete confirmation message and to delete record */
function deletecnfr(r) {
...
function insertRecord(){
  ...
  row.insertCell(15).appendChild(createEditButton("Edit"));
  row.insertCell(16).appendChild(createDeleteButton("Delete"));
